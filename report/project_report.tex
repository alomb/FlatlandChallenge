...
We will mot report here all the details of the two above mentioned algorithms in single-agent setting, which can be found in the references~\citep{trpo}~\citep{ppo}.
