...
The plots clearly show that Rewards Shaping has a positive impact on performance. 
...
As you can see the modification of the loop, in combination with LSTM, brings about a noticeable improvement. \\
...
The result shown in the following graph were obtained using the environment parameters described above, without malfunctions and different speeds for the agents.
...
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_3/score}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_3/completion}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_3/deadlocks}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_3/accumulated_score}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_3/accumulated_completion}
...
In the end we performed the final train using the best combination of hyperparameters and algorithm that emerged from the previous experiments to generate two models:

\begin{itemize}
\item "no-malf-and-speeds" to be evaluated on a set of multi-agent environments \textbf{without} malfunctions and different speeds.
\item "malf-and-speeds" to be evaluated on a set of multi-agent environments \textbf{with} different malfunctions and speeds.
\end{itemize}
\newpage
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_4/score}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_4/completion}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_4/deadlocks}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_4/accumulated_score}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_4/accumulated_completion}
\includegraphics[width=0.33\linewidth]{resources/charts_psppo_4/accumulated_deadlocks}

For the evaluation phase we considered the following environments:
\begin{enumerate}
\item [1.] Medium size:
	\begin{itemize}
	\item $x\_dim = 48$
...
After various tests PS-PPO emerged as most effective algorithm.
It has demonstrating great flexibility in terms of transfer learning and adapting to different environmental settings.
It is more space-efficient and in the future can also be easily parallelized with different agents and \textbf{Vectorized Environments}, making learning even faster.
