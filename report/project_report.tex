...
todo~\ref{fig:psppo_training_final}.
...
\end{figure}
The final results obtained in the evaluation environments are shown in the tables~\ref{tab:evaluation1} and~\ref{tab:evaluation2}.
\begin{table}[]
