...
This section provides an overview of some useful works and theory behind Multi-Agent Reinforcement Learning (MARL) that we consider useful to suggest approaches or solutions to the Flatland Challenge.
...
More information can be found in this~\href{https://openai.com/blog/learning-a-hierarchy/}{OpenAI blog post}.
	\item \textbf{Global graphical observation} has been proposed in some works such as~\citep{Stanford2016MULTIAGENTDR}.
...
We noticed that the agents decide always in the same order, this may cause problems as the Flatland internals actually gives more priority to the agents which have decided first, so in deadlock avoidance this choice can be crucial.
